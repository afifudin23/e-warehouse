<!-- Modal Delete User -->
<div wire:ignore.self class="modal fade" id="delete-user" tabindex="-1" aria-labelledby="deleteUserLabel"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content rounded-lg shadow-lg border-0">

            <div class="modal-header bg-danger text-white rounded-top">
                <h5 class="modal-title d-flex align-items-center" id="deleteUserLabel">
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-borderless mb-0">
                        ...
                        <tr>
                            ...
                            <td>
                                    <span class="badge
                                        {{ $role === 'superadmin' ? 'badge-info' : 'badge-primary' }}
                                        text-capitalize">
                                        {{ $role }}
                                    </span>
                            </td>
